...
import { ChainId, Token, TradeType } from '@myunidavid/sdk-core';
import { FeeAmount } from '@myunidavid/v3-sdk';
...
export async function getV2CandidatePools({
  ...
  // console.log('topByDirectSwapPool', topByDirectSwapPool);
  const subgraphPools = _([
    ...topByBaseWithTokenIn,
    ...topByBaseWithTokenOut,
    ...topByDirectSwapPool,
