...
import { Protocol, SwapRouter, Trade, ZERO } from '@myunidavid/router-sdk';
import {
  ChainId,
  Currency,
  Fraction,
...
import { Pool, Position, SqrtPriceMath, TickMath } from '@myunidavid/v3-sdk';
    ...
    ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  constructor({
    ...
    // ipfs urls in the following format: `https://olive-yummy-sole-591.mypinata.cloud/ipfs/QmPDZRA7rDsPTi8a7jzZ8u38VYXEvZQe7QzidAZq9vP4ob/v1/pools/${protocol}/${chainName}.json`;
    if (v2SubgraphProvider) {
      this.v2SubgraphProvider = v2SubgraphProvider;
    } else {
      // https://olive-yummy-sole-591.mypinata.cloud/ipfs/QmPDZRA7rDsPTi8a7jzZ8u38VYXEvZQe7QzidAZq9vP4ob/v1/pools/v3/goerli.json
      this.v2SubgraphProvider = new V2SubgraphProviderWithFallBacks([
        new CachingV2SubgraphProvider(
          chainId,
          new URISubgraphProvider(
            chainId,
            `https://olive-yummy-sole-591.mypinata.cloud/ipfs/QmPDZRA7rDsPTi8a7jzZ8u38VYXEvZQe7QzidAZq9vP4ob/v1/pools/v2/${chainName}.json`,
            undefined,
            0
          ),
    ...
    if (v3SubgraphProvider) {
      ...
      this.v3SubgraphProvider = new V3SubgraphProviderWithFallBacks([
        new CachingV3SubgraphProvider(
          ...
          new URISubgraphProvider(
            chainId,
            `https://olive-yummy-sole-591.mypinata.cloud/ipfs/QmPDZRA7rDsPTi8a7jzZ8u38VYXEvZQe7QzidAZq9vP4ob/v1/pools/v3/${chainName}.json`,
            undefined,
            0
          ),
          new NodeJSCache(new NodeCache({ stdTTL: 300, useClones: false }))
  ...
  private async getSwapRouteFromChain(
    ...
    if (
      ...
      v3CandidatePoolsPromise = getV3CandidatePools({
        ...
        // console.log('v3_candidatePools', candidatePools);
        metric.putMetric(
          'GetV3CandidatePools',
    ...
    if (
      ...
      // console.log('v2CandidatePoolsPromise_1735');
    ...
    // console.log('bestSwapRoute', bestSwapRoute ? 1 : 2);
    if (bestSwapRoute) {
