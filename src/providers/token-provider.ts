...
import { ChainId, Token } from '@myunidavid/sdk-core';
...
export const USDC_GOERLI = new Token(
  ChainId.GOERLI,
  '0x9136f1886322b56cCa5711F5d385ca19326110bc',
  18,
  'USDC',
  'USD//C'
);
export const USDT_GOERLI = new Token(
  ChainId.GOERLI,
  '0xEB05749Fb22A11E6cfF87dcFE0EbE32CcB2454b9',
  18,
  'USDT',
  'Tether USD'
);
export const WBTC_GOERLI = new Token(
  ChainId.GOERLI,
  '0x570f7fD58aE5b0415a6B1F4e90c6887319614db0',
  18,
  'WBTC',
  'Wrapped BTC'
);
export const DAI_GOERLI = new Token(
  ChainId.GOERLI,
  '0x2b19Ef32B3E3255b9EA2367f78F1dD0f16ABC599',
  18,
  'DAI',
  'Dai Stablecoin'
);
